...
;(function (name, definition) {
  ...
  MeScroll.prototype.extendUpScroll = function(optUp) {
    ...
    MeScroll.extend(optUp, {
      ...
      htmlNodata: '<p class="upwarp-nodata nomore">没有更多了</p>', //无数据的布局
      ...
      showNoMore: function(mescroll, upwarp) {
		...
		//var dataList=document.getElementById("dataList").offsetHeight;
        //target.style.display="block";
		//target.style.top=dataList;
		//$(".bottom").css("top",$("#dataList").height())
      },
